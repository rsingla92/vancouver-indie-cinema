...
export function getDemoShowtimes(now = new Date()): ShowtimeView[] {
  ...
  const showtimes: ShowtimeView[] = [
    ...
    { id: "demo-6", movieId: "2001-a-space-odyssey", title: "2001: A Space Odyssey", year: 1968, synopsis: "Humanity finds a mysterious object buried beneath the lunar surface and sets off to find its origins.", posterUrl: "", backdropUrl: "", theatre: { slug: "park-theatre", name: "The Park Theatre" }, startsAt: at(1, 19), ticketUrl: "https://www.theparktheatre.ca/", status: "scheduled", tags: ["70mm"] },
