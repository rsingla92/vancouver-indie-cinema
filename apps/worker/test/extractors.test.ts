...
describe("Rio Theatre", () => {
  it("maps the Barker REST payload without inventing an end time", () => {
    const result = parseRioPayload([{ id: 350691, event: { id: 350552, title: "Tony", link: "https://riotheatre.ca/movie/tony/" }, start_time: "2026-09-22T18:30:00-07:00", end_time: "2026-09-22T18:30:00-07:00", extra: "", premiere: false, tickets_link: "https://riotheatretickets.ca/events/45357-tony" }]);
...
describe("VIFF", () => {
  it("maps instances and availability independently", () => {
    const html = `<div class="c-event-card"><h3 class="c-event-card__title"><a href="/whats-on/example/">Example Film</a></h3><div class="c-event-instance"><div class="c-event-instance__time">6:10 pm</div><div class="c-event-instance__date"><span>Sat Sep 26</span></div><span class="c-event-instance__venue">VIFF Cinema</span><button data-eventid="50784" data-instanceid="55880"></button><a class="c-event-instance__btn" href="/whats-on/example/book/opaque">Book now</a></div></div>`;
...
describe("Hollywood Theatre", () => {
  it("keeps film events and creates one record per advertised show time", () => {
    ...
    expect(result[0]).toMatchObject({ rawTitle: "Example Film", startsAt: "2026-09-30T19:00:00-07:00", ticketUrl: "https://tickets.example.com/example", tags: ["film"] });
  });
